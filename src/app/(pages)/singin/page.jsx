...
export default function page() {
  return (
    <div
      className="bg-secondary rounded-lg grid grid-cols-1 lg:grid-cols-2 place-items-center h-full"
    >
      <section className="hidden place-items-center lg:grid">
        <Image className="w-2/3" src={ImageLogin} alt="Imagen de realizar reporte" />
      </section>
